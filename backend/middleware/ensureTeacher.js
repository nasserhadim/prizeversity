...
//9/21 this file was created to ensure that only teachers can access certain routes. It checks the user's role and allows access if the user is a teacher or an admin. If not, it returns a 403 Forbidden response.