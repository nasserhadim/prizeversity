export const getChallengeColors = (challengeIndex, isDark) => {
  const colorSchemes = [
    // Challenge 1 - Red theme
    {
      ...
      completedText: isDark ? 'text-green-300' : 'text-green-800',
      sectionBg: isDark ? 'bg-red-800/30 border-red-600/50' : 'bg-white border-red-300'
    },
    // Challenge 2 - Blue theme
    {
      ...
      completedText: isDark ? 'text-green-300' : 'text-green-800',
      sectionBg: isDark ? 'bg-blue-800/30 border-blue-600/50' : 'bg-white border-blue-300'
    },
    // Challenge 3 - Purple theme
    {
      ...
      completedText: isDark ? 'text-green-300' : 'text-green-800',
      sectionBg: isDark ? 'bg-purple-800/30 border-purple-600/50' : 'bg-white border-purple-300'
    },
    // Challenge 4 - Orange theme
    {
      ...
      completedText: isDark ? 'text-green-300' : 'text-green-800',
      sectionBg: isDark ? 'bg-orange-800/30 border-orange-600/50' : 'bg-white border-orange-300'
    },
    // Challenge 5 - Cyan theme
    {
      cardBg: isDark ? 'bg-cyan-900/20 border-cyan-700/50' : 'bg-cyan-50 border-cyan-200',
      completedBg: isDark ? 'bg-green-900/20 border-green-700/50' : 'bg-green-50 border-green-200',
      textColor: isDark ? 'text-cyan-300' : 'text-cyan-800',
      completedText: isDark ? 'text-green-300' : 'text-green-800',
      sectionBg: isDark ? 'bg-cyan-800/30 border-cyan-600/50' : 'bg-white border-cyan-300'
    }
  ];
...
export const getThemeClasses = (isDark) => ({
  ...
  bodyText: isDark ? 'text-gray-200' : 'text-gray-700',
  sectionBg: isDark ? 'bg-gray-800/50 border border-gray-600' : 'bg-white border border-base-200',
  codeRed: isDark ? 'bg-red-900/40 text-red-200 border-red-600/50' : 'bg-red-100 text-red-700',
  codeBlue: isDark ? 'bg-blue-900/40 text-blue-200 border-blue-600/50' : 'bg-blue-100 text-blue-800',
  infoAlert: isDark ? 'alert alert-info bg-blue-900/30 text-blue-200 border-blue-600/50' : 'alert alert-info',
  warningAlert: isDark ? 'alert bg-orange-900/30 border border-orange-600/50 text-orange-200' : 'alert alert-warning',
  linkText: isDark ? 'text-blue-300' : 'text-blue-600'
});
