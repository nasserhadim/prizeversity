...
const Terms = () => {
  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        "**Educational Privacy:**",
        "• We comply with FERPA, COPPA, and applicable state privacy laws",
        "• Student data is used only for educational purposes",
        "• Parents/guardians have rights to access student information",
        "• Schools/Teachers maintain primary control over student data",
        "",
        "**Data Collection:**",
